...
import com.example.springcloudzuul.util.JudgeRbacCustomer;
...
@Component
public class AuthZuulFilterCustomer extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        if(request.getRequestURI().contains("provider-xqr/customer/manageCart")){
    ...
    public Object run() throws ZuulException {
        JudgeRbacCustomer judgeRbacCustomer=new JudgeRbacCustomer();
        RequestContext ctx= RequestContext.getCurrentContext();
        ...
        if (StringUtils.isEmpty(token)){
            ...
            if(!judgeRbacCustomer.play(uid,rid)){
